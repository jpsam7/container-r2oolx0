...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r2oolx0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r2oolx0.containers.anotherwebservice.com/
...
```
git clone git@github.com:jpsam7/container-r2oolx0.git
cd container-r2oolx0
```
...
```
docker attach container-r2oolx0
```
